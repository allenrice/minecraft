...
export class viewModel {
    ...
    appName: KnockoutObservable<string> = ko.observable("minecraft");
    ...
    exampleData: minecraft.Models.TypeLiteDemoClass;

    constructor(params: { data: minecraft.Models.TypeLiteDemoClass }) {
